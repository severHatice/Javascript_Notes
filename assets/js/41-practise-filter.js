...
const loadCountries = () => { 
  ...
  let totalArea = countries.reduce( (t, c) => t+c.area, 0).toFixed(2);//object ve area toplarken mumkun degil ama ilk degere 0 verince area lari topladi??/
